...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex border-dashed border-b-[1px] border-b-gray-400">
      <AccordionPrimitive.Trigger
        onClick={() => { setIsOpen(triggerRef.current.getAttribute("data-state")) }}
        ref={triggerRef}
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-sm pt-[38px]"
      {...props}>
